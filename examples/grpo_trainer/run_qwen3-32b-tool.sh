...
#     actor_rollout_ref.model.path=/workspace/verl/models/qwen3-32b \
...
#!/bin/bash
# Training script using RLLM reward manager with local rllm_rewards module
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_32b_rllm_rewards' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 \
    reward_model.reward_manager=rllm $@ > output_rllm.txt 2>&1