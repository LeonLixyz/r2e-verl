...
class RayPPOTrainer:
    ...
    def _create_dataloader(self, train_dataset, val_dataset, collate_fn, train_sampler):
        ...
        print(f"[DEBUG] in ray_trainer._create_dataloader, train_dataset: {train_dataset}")
        print(f"[DEBUG] in ray_trainer._create_dataloader, val_dataset: {val_dataset}")
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # Preserve docker_image for R2E-Gym integration
            if "docker_image" in test_batch.non_tensor_batch:
                non_tensor_batch_keys_to_pop.append("docker_image")
    ...
    def fit(self):
        ...
        print(f"[DEBUG] in ray_trainer.fit, loaded checkpoint")
        ...
        for epoch in range(self.config.trainer.total_epochs):
            print(f"[DEBUG] in ray_trainer.fit, epoch: {epoch}")
            for batch_dict in self.train_dataloader:
                # print(f"[DEBUG] in ray_trainer.fit, batch_dict: {batch_dict}")
                ...
                if "interaction_kwargs" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("interaction_kwargs")
                # Preserve docker_image for R2E-Gym integration
                if "docker_image" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("docker_image")
                gen_batch = batch.pop(
                    batch_keys=batch_keys_to_pop,
                    non_tensor_batch_keys=non_tensor_batch_keys_to_pop,
