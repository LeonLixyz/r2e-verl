...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            if vllm_mode == "customized":
                ...
                print(f"[DEBUG] I am using {vllm_rollout_cls} init with config: {self.config.rollout}")
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        # print(f"[DEBUG] Hey I am using FSDP actor rollout ref worker, prompts: {prompts}")
        ...
        with self.rollout_sharding_manager:
            ...
            with simple_timer("generate_sequences", timing_generate):
                print(f"[DEBUG] Hey I am now generating sequences")
...
class AsyncActorRolloutRefWorker(ActorRolloutRefWorker):
    ...
    @register(dispatch_mode=Dispatch.DP_COMPUTE_PROTO)
    def generate_sequences(self, prompts: DataProto):
        print(f"[DEBUG] I am using AsyncActorRolloutRefWorker generate_sequences with prompts: {prompts}")
