...
#         Your task is to solve coding problems efficiently and correctly. You will be given a problem statement and a set
#         of tools to use. When you finish the problem, you should output the final python code in the output format below.
...
#         Output format:
#         - Your final python code in the following format:
#         Final code:
#         ```python
#         # ... your code ...
#         ```
...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # print(f"[DATASET_DEBUG] Item {item} - original row_dict keys: {list(row_dict.keys())}")
        # print(f"[DATASET_DEBUG] Item {item} - docker_image: {row_dict.get('docker_image', 'MISSING')}")
        messages = self._build_messages(row_dict)
        # print(f"[DATASET_DEBUG] Item {item} - after _build_messages, row_dict keys: {list(row_dict.keys())}")
        model_inputs = {}
        ...
        if self.processor is not None:
            ...
            # print(f"[DEBUG] Hey inside RLHFDataset.__getitem__, applying chat template to messages: {messages}")
            raw_prompt = self.tokenizer.apply_chat_template(messages, add_generation_prompt=True, tokenize=False, tools=TOOLS, enable_thinking = True)
            # print(f"[DEBUG] Hey inside RLHFDataset.__getitem__, raw_prompt: {raw_prompt}")
        ...
        # print(f"[DATASET_DEBUG] Item {item} - final row_dict keys before return: {list(row_dict.keys())}")
        # print(f"[DATASET_DEBUG] Item {item} - final docker_image: {row_dict.get('docker_image', 'MISSING')}")
        return row_dict
